...
FrameAbout::FrameAbout(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size,
    ...
    wxString myVersion;
    // software version
    myVersion << "Version: " << Fosi_MAJOR_VERSION << "." << Fosi_MINOR_VERSION << "." << GIT_NUMBER << "\n";
...
void FrameAbout::_create_controls() {
    ...
    m_staticText1 = new wxStaticText(m_panel1, wxID_ANY, _("Fosi"), wxDefaultPosition, wxDefaultSize, 0);
